...
```
```{r pot_rotation_plot2, echo = FALSE, warning = FALSE, fig.cap="Incomplete Trays behave as complete trays when rotating pots."}
...
```{r pot_randomisation_pre, echo = FALSE, warning = FALSE, fig.cap="Pots with names assigned in sequential order"}
square_pots_with_labels$board_1$board_plot
```

```{r pot_randomisation_post, echo = FALSE, warning = FALSE, fig.cap="Pots ordered by replicate-index"}
